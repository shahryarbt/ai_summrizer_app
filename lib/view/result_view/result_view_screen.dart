...
class ResultScreenView extends StatefulWidget {
  int index;
  ResultScreenView({super.key, required this.index});
...
class _ResultScreenViewState extends State<ResultScreenView>
  ...
  int get wordCount {
    if (controller.originalText.value.trim().isEmpty) return 0;
  ...
  void initState() {
    ...
    super.initState();
    // controller.    originalTextcontroller.text =
                ...
                children: [
                  ...
                  Obx(
                    () => Expanded(
                      ...
                      //  TextField(
                      //   controller: controller.humarizeTextcontroller,
